...
var KySu = /** @class */ (function (_super) {
    ...
    function KySu(nganhdaotao, hoten, ngaysinh, diachi, gioitinh) {
        var _this = _super.call(this, hoten, ngaysinh, diachi, gioitinh) || this;
        _this._nganhdaotao = nganhdaotao;
        return _this;
    }
    KySu.prototype.getNganhDaoTao = function () {
        return this._nganhdaotao;
    };
    KySu.prototype.setNganhDaoTao = function (nganhdaotao) {
